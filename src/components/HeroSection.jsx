  ...
  return (
    <section className='h-svh'>
      <div className='grid grid-cols-1 lg:grid-cols-12 my-4 h-[60%]'>
        ...
        <div className='col-span-7 place-self-center place-items-start gap-4'>
          <h1 className='mb-2 lg:mb-4 lg:text-6xl text-4xl font-extrabold'>
            <span className='text-transparent text-4xl lg:text-7xl bg-clip-text bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500'>
              Hi there <span className='text-white'>👋</span> I&apos;m {" "}
            </span>
            <br />
            <span className='text-4xl lg:text-7xl text-white'>
              <TypeAnimation
                sequence={[
                  'Ahamed Kabeer',
                  1000,
          ...
          <div className='flex'>
            ...
            <div className="flex gap-2">
              <a href='https://www.linkedin.com/in/ahamed-kabeer-aktech27/' target='_blank' className="bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 px-1 py-1 rounded-full">
              ...
              <a href='https://github.com/aktech27' target='_blank' className="bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 px-1 py-1 rounded-full">
              ...
              <a href='https://leetcode.com/u/aktech27/' target='_blank' className="bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 px-1 py-1 rounded-full">
                <span className="block bg-white hover:bg-slate-400 rounded-full h-35 w-35">
